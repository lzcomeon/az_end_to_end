...
def generate_az_rois(size, gt_rois):
    ...
    adj_labels, zoom_labels, im_rois, adj_targets, adj_loss_weight \
        = _sample_rois(zoom_labels, ex_rois, targets, 128, 256)

    return adj_labels, zoom_labels, im_rois, adj_targets, adj_loss_weight, ex_rois
...
if __name__ == '__main__':
    ...
    for i, (img, bbox_, label_, scale) in tqdm(enumerate(dataloader)):
        ...
        adj_labels, zoom_labels, im_rois, adj_targets, adj_loss_weight, ex_rois = generate_az_rois(size, bbox)
